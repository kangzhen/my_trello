...
use tBundle\Entity\TaskList;
use tBundle\Form\TaskListType;
...
class TaskListController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('tBundle:TaskList')->findAll();
     ...
     * @Method("POST")
     * @Template("tBundle:TaskList:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('tBundle:TaskList')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("tBundle:TaskList:edit.html.twig")
     */
