...
use tBundle\Entity\Task;
use tBundle\Form\TaskType;
...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('tBundle:Task')->findAll();
     ...
     * @Method("POST")
     * @Template("tBundle:Task:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('tBundle:Task')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("tBundle:Task:edit.html.twig")
     */
